...
export function useExpenseService() {
    ...
    return {
         ...
         * is an object containing the results and the additional information for the
         * pagination.
         ...
         */
        async getListAsync(requestDto?: RequestDtos.Expense.List)
                :Promise<RequestDtos.Expense.List> {
         ...
         * an object containing the details of the expense.
