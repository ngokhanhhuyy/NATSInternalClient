...
export class ExpenseListModel {
    ...
    public toRequestDto(): ExpenseListRequestDto {
        return {
            ...
            rangeFrom: this.rangeFrom && this.rangeFrom.toRequestDtoDateString(),
            rangeTo: this.rangeTo && this.rangeTo.toRequestDtoDateString(),
    ...
    public toRequestDto(): ExpenseUpsertRequestDto {
        return {
            ...
            paidDateTime: !this.paidDateTime
                ? null
                : this.paidDateTime.toRequestDtoDateTimeString(),
            category: this.category,
            note: this.note || null,
