<script setup lang="ts" generic="
    TUpdateHistoryModel extends IExportProductUpdateHistoryModel<TUpdateHistoryItemModel>,
    TUpdateHistoryItemModel extends IExportProductItemUpdateHistoryModel">
// Imports.
...
// Model and states.
const model = defineModel<TUpdateHistoryModel[]>({ required: true });
...
function isStatsDateTimeVisible(updateHistory: TUpdateHistoryModel): boolean {
    return updateHistory.oldStatsDateTime != updateHistory.newStatsDateTime;
}

function isNoteVisible(updatedHistory: TUpdateHistoryModel): boolean {
    return updatedHistory.oldNote != updatedHistory.newNote;
}

function areItemsVisible(updateHistory: TUpdateHistoryModel): boolean {
