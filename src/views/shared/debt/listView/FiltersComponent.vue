...
<script setup lang="ts" generic="
    TListModel extends IDebtListModel<TBasicModel, TAuthorizationModel>,
...
const blockTitle = `Danh sách ${props.displayName}`;
</script>

<template>
    <MainBlock :title="blockTitle" :body-padding="[0, 2, 2, 2]" body-class="row g-3">
        <!-- Header -->
        <template #header>
