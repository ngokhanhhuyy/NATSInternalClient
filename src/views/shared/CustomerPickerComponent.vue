...
<template>
    <MainBlock title="Chọn khách hàng" :body-padding="[2, 2, 3, 2]">
        <template #body>
            <!-- Search and list -->
            <div class="row g-3" v-if="model == null">
                <!-- Search by content -->
                <div class="col col-12">
                    ...
                    <span class="small opacity-50">
                        Nhập tối thiểu 3 ký tự. Ví dụ: Nguyễn Văn An, 30-08-1997, 09037632117 ...
                    </span>
                </div>
                ...
                <div class="col col-12 mt-3">
                    <ul class="list-group">
                        <li class="list-group-item d-flex align-items-center"
                                :key="customer.id"
                                v-for="customer in customerListModel.results">
                            <!-- Avatar -->
