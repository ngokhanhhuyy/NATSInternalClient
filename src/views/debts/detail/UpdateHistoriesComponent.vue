<script setup lang="ts" generic="TUpdateHistoryModel extends IDebtUpdateHistoryModel">
...
function isAmountVisible(updateHistory: TUpdateHistoryModel): boolean {
                        ...
                        <div class="accordion-body p-2">
                            ...
                            <div class="row g-3" v-if="isNoteVisible(updateHistory)">
                                <div :class="columnClass">
                                    ...
                                    <span class="text-primary opacity-50" v-else>
                                        Để trống
                                    </span>
                                </div>
